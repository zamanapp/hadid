...
from .types import Page, HadidOutput
...
async def hadid(
    ...
    **kwargs,
    ...
    :param temp_dir: The directory to store temporary files, defaults to some named folder in system's temp directory. If already exists, the contents will be deleted for hadid uses it.
    :type temp_dir: str, optional
    :param custom_system_prompt: The system prompt to use for the model, this overrides the default system prompt of hadid. Generally it is not required unless you want some specific behaviour. When set, it will raise a friendly warning, defaults to None
    ...
    with tempfile.TemporaryDirectory() as temp_dir_:
        ...
        if select_pages is not None:
            ...
            local_path = await asyncio.to_thread(
                create_selected_pages_pdf, **subset_pdf_create_kwargs
            )
